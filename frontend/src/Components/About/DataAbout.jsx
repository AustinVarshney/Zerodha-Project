...
const DataAbout = () => {
  return (
    <div className='container outerDataAboutDiv'>
      <div>
      ...
      <div>
        ...
        <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <span>blog</span> or see what the media is <span>saying about us</span>.</p>
      </div>
    </div>
  )
}
